    ...
    <section class="mt-5 padding">
                    <div class="row g-4">
                      <!--Control Registered Student-->
                        ...
                        <a href="a_post_grade.php" class="col-md-3" style="text-decoration: none;">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    <h4><i class="fas fa-chalkboard-teacher"></i> Post Grade</h4>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="a_post_news.php" class="col-md-3" style="text-decoration: none;">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    <h4><i class="fas fa-user-graduate"></i> Post News</h4>
                                </div>                      
                            </div>
                        ...
                        <!-- View Comments -->
                        <a href="a_view_comments.php" class="col-md-3" style="text-decoration: none;">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    <h4><i class="fas fa-user-graduate"></i> View Comments</h4>
                                </div>                      
                            </div>
