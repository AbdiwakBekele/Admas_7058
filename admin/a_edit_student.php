...
// Database Update PHP Code 
    ...
    if(isset($_POST['Submit'])){
        ...
        if($student_password == $confirm_student_password){
            ...
            $query = "UPDATE student SET student_fullname = '$student_fullname', student_email = '$student_email', student_password = '$student_password' WHERE student_id = '$student_id' ";
    ...
    if(isset($_REQUEST['id'])){
        ...
        $array = array();
              ...
              while ($r = mysqli_fetch_assoc($q_result )){
                $array['student_fullname'] = $r['student_fullname'];
...
<form class="was-validated bg-light border shadow p-3" action="a_edit_student.php" method="POST" enctype="multipart/form-data" name="form">
        ...
        <div class="row mt-3">
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control" name="student_fullname" id="fullname" placeholder="Enter Full Name" value=" <?php echo $array['student_fullname']; ?>" required>
