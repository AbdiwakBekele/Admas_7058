...
<body>
    ...
    <a href="a_add_student.php" ><button> Add New Student </button></a>
                                ...
                                <table class="table table-bordered table-striped table-hover">
                                  ...
                                  <tbody>
                                    ...
                                    <td class="text-center h4">
                                        <a href="a_edit_student.php?id=<?php echo $row['student_id'] ?>"><i>Edit</i></a>
                                        <br>
                                        <a href="a_delete_student.php?id=<?php echo $row['student_id'] ?>"><i>Delete</i></a>
                                    </td>
