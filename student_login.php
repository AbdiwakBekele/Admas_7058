...
<form class="was-validated border p-4 mb-4 bg-light border shadow the_logo_form" action="student_login_ctrl.php" method="post" name="form" onsubmit="return validated()">

                    <div class="mt-3 mb-3">
                        <label for="mail" class="form-lable"><i ></i> Email</label>
                        <input type="email" class="form-control" name="student_email" id="mail" placeholder="Enter Your Email" required="required">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" name="student_password" id="pswd" placeholder="Enter Your Password" required="required">
                            <div class="valid-feedback">good</div>   
